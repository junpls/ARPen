...
class PluginManager: ARManagerDelegate, PenManagerDelegate {
    ...
    var plugins: [Plugin] = [CurvePlugin(), CombinePluginFunction(), CombinePluginSolidHole(), SweepPluginProfileAndPath(), SweepPluginTwoProfiles(), RevolvePluginProfileAndAxis(), RevolvePluginProfileAndCircle(), RevolvePluginTwoProfiles(), LoftPlugin()]
