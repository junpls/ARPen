...
class PluginManager: ARManagerDelegate, PenManagerDelegate {
    ...
    var plugins: [Plugin] = [PaintPlugin(), ArrangePlugin(), SweepPluginProfileAndPath(), SweepPluginTwoProfiles(), RevolvePluginProfileAndAxis(), RevolvePluginProfileAndCircle(), LoftPlugin()]
