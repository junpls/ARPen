...
class PluginManager: ARManagerDelegate, PenManagerDelegate {
    ...
    var plugins: [Plugin] = [CurvePlugin(), ArrangePluginFunction(), ArrangePluginSolidHole(), SweepPluginProfileAndPath(), SweepPluginTwoProfiles(), RevolvePluginProfileAndAxis(), RevolvePluginProfileAndCircle(), RevolvePluginTwoProfiles(), LoftPlugin()]
